		...
		<div className="min-h-screen w-full flex items-center justify-center p-6">
			<div className="relative w-full max-w-md">
				...
				<motion.div
					...
					className="mb-6 border border-gray-200 rounded-xl p-4 text-center shadow-sm"
				>
					...
					<motion.button
						...
						className="mt-4 w-full rounded-lg bg-blue-600 px-4 py-3 text-sm font-medium text-white hover:bg-blue-700"
					>
				...
				<motion.div
					initial={{ opacity: 0, y: 20 }}
					animate={{ opacity: 1, y: 0 }}
					className=" border border-gray-200 shadow-lg rounded-xl p-6"
				>
					...
					>
						...
						<div>
							...
							<div className="relative">
								...
								<input
									...
									className="w-full rounded-lg bg-white border border-gray-200 pl-12 pr-4 py-3 text-sm text-gray-900 placeholder-gray-700 outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20"
									{...register('email')}
								/>
							</div>
						...
						<div>
							<div className="flex items-center justify-between mb-2">
								...
								<Link className="text-xs text-blue-600 font-medium hover:underline">
									Forgot password?
								</Link>
							</div>
							...
							<div className="relative">
								...
								<input
									...
									className="w-full rounded-lg bg-white border border-gray-200 pl-12 pr-12 py-3 text-sm text-gray-900 placeholder-gray-700 outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20"
									{...register('password')}
								/>
